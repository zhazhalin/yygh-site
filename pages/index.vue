    ...
    <div class="bottom">
      ...
      <span
        ...
        <div class="v-scroll-list hospital-list">
          <div v-for="(item,index) in list" :key="index" @click="show(item.hoscode)" class="v-card clickable list-item">
            <div class="">
              <div
...
<script>
import hosp from "~/api/hosp/hosp";
